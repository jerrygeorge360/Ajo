    ...
    <div className="app-container">
      ...
      >
        <div className="header-content">
          ...
          >
            The world's oldest savings tradition, reimagined with blockchain technology
          </motion.p>
      ...
      {!isConnected ? (
        ...
        >
          <div className="connect-card card">
            ...
            <p className="connect-description">Join the decentralized savings circle on Flow EVM Testnet</p>
            <div className="connector-buttons">
              {connectors.map((connector) => (
                <button key={connector.id} onClick={() => connect({ connector })} className="btn btn-primary btn-large">
        ...
        <>
          ...
          >
            ...
            <button onClick={() => disconnect()} className="btn btn-secondary btn-small">
              Disconnect
            </button>
          </motion.div>
